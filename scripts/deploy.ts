...
import { ScHelloworld } from '../src/contracts/scHelloworld'
...
async function main() {
    await ScHelloworld.loadArtifact()
    ...
    const instance = new ScHelloworld(
    ...
    console.log('ScHelloworld contract was successfully deployed!')
